...
main = do
  ...
  let scriptname = if nargs > 1 then args!!1 else  "blockfrostHello.plutus"
  putStrLn $ "Writing output to: " ++ scriptname
  writePlutusScript helloMessage scriptname helloSerialised helloSBS

  putStrLn $ "Validator hash: " ++ show helloHash
        ...
        Just m ->
          ...
          in do print ("Log output" :: String) >> print logout
                ...
                Data.ByteString.Lazy.putStrLn
                  $ "Datum value: " <> encode (scriptDataToJson ScriptDataJsonDetailedSchema $ fromPlutusData pData)
